package com.example.collegeapp.jointdirector.login

import com.example.collegeapp.warden.login.SignInState
import com.example.collegeapp.warden.login.SignInViewModel
...
@Composable
fun LoginScreenJD(navController: NavController) {
